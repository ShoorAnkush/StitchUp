      ...
      <nav className="relative bg-[#f9f9f9] shadow-sm border-b border-gray-200">
        <div className="flex items-center justify-between px-4 md:px-8 h-16 relative">
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 transition">
            <Link href="/">
              <div className="h-36 md:h-42 w-auto">
                <Image
                  src="/images/logo.png"
                  alt="StitchUp Logo"
                  width={500}
          ...
          {/* Right Icons */}
          <div className="flex items-center gap-3 md:gap-5 text-2xl relative z-20">
            {/* Search box */}
            <div className="hidden lg:flex items-center border rounded-full px-3 py-1 gap-2 bg-white shadow-sm hover:shadow-md transition w-[180px] md:w-[220px]">
              <input
                type="text"
            ...
            <Link href="/wishlist" className="relative">
              ...
              {wishlistItems.length > 0 && (
                <span className="absolute -top-2 -right-2 bg-red-600 text-white text-xs font-bold rounded-full w-5 h-5 flex items-center justify-center shadow-sm">
